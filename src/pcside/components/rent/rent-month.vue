  ...
  <div class="rent-month">
    <el-tabs
      ...
      <el-tab-pane
        ...
        <!-- 计租表单 -->
        <el-dialog custom-class="add-month-det-dialog"
            ...
            <template slot-scope="props">
              <el-form class="table-expand"
                ...
                <el-form-item
                  ...
                  <template>
                    <div
                      v-if="props.row.rents.length && getRent(props).calWater">
                ...
                <el-form-item
                  ...
                  <template>
                    <div
                      v-if="props.row.rents.length && getRent(props).calElectric">
          ...
          <el-table-column
            ...
            <el-table-column
              ...
              <el-table-column
                ...
                <template slot-scope="scope">
                  <div
                    v-if="scope.row.rents.length && getRent(scope).calWater">
                    <el-tag>
            ...
            <el-table-column
              ...
              <el-table-column
                ...
                <template slot-scope="scope">
                  <div
                    v-if="scope.row.rents.length && getRent(scope).calElectric">
                    <el-tag>
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                <div
                  v-if="scope.row.rents.length && getRent(scope).lease.name">
                  <el-tag>
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                <div
                  v-if="scope.row.rents.length && getRent(scope).type">
                  <el-popover
                    placement="top"
                    trigger="hover"
                ...
                <el-tag
                  v-if="scope.row.rents.length && (getRent(scope).type && !getRent(scope).type.type.length || !getRent(scope).type)">
                  新建
                </el-tag>
                <div class="unimportant"
                  v-if="scope.row.rents.length">
